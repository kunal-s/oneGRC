...
import { ArrowLeft, ArrowUpRight, CheckCircle2, ShieldAlert, ClipboardCheck, Siren, CalendarClock } from 'lucide-react'
        ...
        <div className="space-y-4">
          <div className="card-surface p-3.5">
            ...
            <p className="mt-2 text-2xs leading-relaxed text-muted-foreground">
              <span className="font-medium text-foreground">One object.</span> This issue traces straight back to what
              raised it — close the loop and the source record reflects it.
            </p>
          </div>
        </div>
      </div>
