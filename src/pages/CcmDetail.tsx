  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        <span className="text-2xs text-muted-foreground">— one rule, evidence reused across {rule.frameworks.length} frameworks</span>
      </div>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1.7fr)_minmax(0,1fr)]">
        <div className="space-y-4">
          ...
          {(issue || incident) && (
            <div className="card-surface p-4">
              <h3 className="mb-3 text-sm font-semibold text-foreground">Auto-escalation — no analyst re-keys anything</h3>
              ...
              <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2">
                ...
                {incident && (
                  <div className="rounded-md border border-border p-2.5">
                    ...
                    <div className="mt-0.5 text-2xs text-muted-foreground">Three regulator clocks running · one evidence trail</div>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="space-y-4">
          <div className="card-surface p-4">
            ...
            <p className="mt-2 text-2xs leading-snug text-muted-foreground">
              Every run writes evidence straight to the control record — the same artefacts satisfy {rule.frameworks.length}{' '}
              frameworks. No screenshots, no spreadsheets.
            </p>
          </div>
