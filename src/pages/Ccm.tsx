  ...
  return (
    <div>
      <PageHeader
        ...
        description="Controls tested continuously against the full population — evidence auto-captured on every run, failures auto-escalate to an Issue and the linked incident. No analyst re-keys anything."
      />
      ...
      <div className="card-surface overflow-hidden">
        <div className="flex items-center justify-between border-b border-border bg-muted/40 px-4 py-2">
          ...
          <span className="inline-flex items-center gap-1 text-2xs text-muted-foreground">
            <Activity className="size-3.5" /> live · evidence auto-captured each run
          </span>
        </div>
