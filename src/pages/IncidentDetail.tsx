...
import {
  ...
  Network, Zap, Download, Clock, Boxes,
} from 'lucide-react'
...
export function IncidentDetail() {
  ...
  return (
    <div>
        ...
        <div className="mb-4">
          <div className="mb-2 flex items-center justify-between">
            <h2 className="flex items-center gap-1.5 text-sm font-semibold text-foreground">
              ...
              {inc.regulatorTracks.length} regulator {inc.regulatorTracks.length === 1 ? 'track' : 'tracks'} · one
              incident record · one evidence trail
            </h2>
      ...
      {/* Timeline + shared object */}
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]">
        <div className="space-y-4">
          <div className="card-surface p-4">
            <h2 className="mb-3 text-sm font-semibold text-foreground">
              Unified timeline — one record, three regulator outputs
            </h2>
        ...
        <div className="space-y-4">
          ...
          <div className="card-surface p-3.5">
            <div className="mb-2 flex items-center justify-between">
              ...
              <span className="text-2xs text-muted-foreground">{inc.evidence.length} items · one trail</span>
            </div>
            ...
            <p className="mt-2 text-2xs leading-snug text-muted-foreground">
              The same evidence trail backs all {inc.regulatorTracks.length || 'the'} regulator{' '}
              {inc.regulatorTracks.length === 1 ? 'output' : 'outputs'} — captured once, reused across CERT-In, PFRDA
              and DPDP.
            </p>
          </div>
