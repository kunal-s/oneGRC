  ...
  return (
    <div>
      <PageHeader
        ...
        title="My Queue"
        description="Role-aware tasks routed to you across every GRC domain — maker-checker approvals, control re-tests, incident actions on the clock, audit evidence and DSARs. Switch role (top-right) to see another line of defence's queue."
        actions={
      ...
      <div className="mt-3 flex items-center justify-between text-2xs text-muted-foreground">
        <span>Three lines of defence · {persona.lod} · tasks routed per persona under maker-checker control.</span>
        <span className="inline-flex items-center gap-1">
          <StatusChip status="Maker-checker" tone="info" /> approvals route to the relevant 2LoD/3LoD owner.
        </span>
      </div>
    </div>
  )
