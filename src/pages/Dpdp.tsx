        ...
        <div className="space-y-4">
          ...
          >
            ...
            <p className="mt-1.5 text-2xs leading-relaxed text-muted-foreground">
              A personal-data breach detected here opens an incident on the same workflow — {MARQUEE.id} (ransomware,
              personal data involved) is running its DPDP ~72-hour track alongside CERT-In and PFRDA. One workflow, not three.
            </p>
          </button>
        </div>
      </div>
