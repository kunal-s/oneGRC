...
export const SOURCES: SourceProvision[] = [
  ...
  prov({
    ...
    aiRecommendation: ai('Map to the DSAR fulfilment control on the OneTrust spoke; track the access-request SLA.', 82.4, 'Section 11 access right applies to subscriber data.', t(2026, 6, 10, 9, 18)),
    status: 'Recommended',
  }),
  prov({
    id: 'SRC-DPDP-12',
  ...
  prov({
    ...
    aiRecommendation: ai('Map to a grievance-redressal control with a 90-day SLA on the OneTrust spoke.', 80.9, 'Section 13 grievance duty; 90-day period per the Rules.', t(2026, 6, 10, 9, 20)),
    status: 'Recommended',
  }),
  prov({
    id: 'SRC-DPDP-RULE8',
