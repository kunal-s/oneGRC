...
/**
 * "Where this also appears" — the thesis motif. Shows the shared object's
 * cross-references across IT and enterprise views.
 */
  ...
  return (
    <div className={cn('card-surface p-3.5', className)}>
      ...
      <p className="mb-3 text-2xs leading-snug text-muted-foreground">
        One shared record. The same object surfaces across IT-GRC and enterprise/regulatory views.
      </p>
